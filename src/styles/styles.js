export const appStyles = {
  ...
  loginFormBox: {
    ...
    borderRadius: '24px',
    padding: '3.25rem 4rem 3.1rem',
    boxShadow: '0 15px 40px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.22)',
  ...
  loginInputFocus: {
    ...
    boxShadow: '0 0 0 3px rgba(124, 58, 237, 0.13), 0 8px 20px rgba(15, 23, 42, 0.08)',
  },
  loginButtonGroup: {
    display: 'grid',
